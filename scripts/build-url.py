...
def build_url(cfg: dict) -> str:
    ...
    # inner_urlpath = f"{DEFAULTS['urlpath']}?{inner}"
    base_url = "http://localhost:8888/"

    return f'{base_url}{inner_urlpath}'

    # binder_base = cfg["binder_base"].rstrip("/")
    # launcher_repo = cfg["launcher_repo"]
    # launcher_ref = cfg["launcher_ref"]
    #
    # return (
    #     f"{binder_base}/v2/gh/{launcher_repo}/{launcher_ref}"
