...
```text
https://mybinder.org/v2/gh/recap/binder-wrapper-repo/main?urlpath=binder-launch?repo=https://github.com/ORG/TARGET_REPO&branch=main&urlpath=lab/tree/notebook.ipynb&csv_url=https://example.org/data.csv&dataset_pid=doi:10.1234/abcd
```
